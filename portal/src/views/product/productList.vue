<template>
    <el-card shadow="always" class="maincard" id="maincard">
        <el-row>
            <el-col :span="24" class="breadcrumbgroup">
                <el-col :span="12">
                    ...
                    <el-breadcrumb separator="/">
                        ...
                        <el-breadcrumb-item id="sss">产品</el-breadcrumb-item>
                    </el-breadcrumb>
                </el-col>
                ...
                <el-col :span="12" class="serachgroup">
                    ...
                    <el-button type="text" icon="el-icon-plus" size="medium"  @click="createRow()" >新建产品 </el-button>
                </el-col>

            </el-col>
            <el-col :span="24" >
                <el-table :data="list.row" border     :height="tableHeight"   >
                                                 
                                                                                                     
                    <el-table-column label-class-name='22222222222' width="" min-width=""   v-if=" '1'=='1' "  prop="name" label="产品名称"  >
                    ...
                    <el-table-column label-class-name='22222222222' width="" min-width=""   v-if=" '1'=='1' "  prop="unit" label="产品单位"  >
                    ...
                    <el-table-column label-class-name='22222222222' width="" min-width=""   v-if=" '1'=='1' "  prop="code" label="产品编码"  >
                    ...
                    <el-table-column label-class-name='22222222222' width="" min-width=""   v-if=" '1'=='1' "  prop="price" label="价格"  >
                    ...
                    <el-table-column label-class-name='22222222222' width="" min-width=""   v-if=" '1'=='1' "  prop="type" label="产品类型"  >

                    <template slot-scope="scope">
                    {{   util.formatterDic( 'user', scope.row.type )   }}
                    </template>
                    ...
                    <el-table-column label-class-name='22222222222' width="" min-width=""   v-if=" '1'=='1' "  prop="typename" label="产品类型名称"  >
                    ...
                    <el-table-column label-class-name='22222222222' width="" min-width=""   v-if=" '1'=='1' "  prop="enable" label="启用"  >
                    ...
                    <el-table-column label-class-name='22222222222' width="" min-width=""   v-if=" '1'=='1' "  prop="desc" label="描述"  >
                    ...
                    <el-table-column label-class-name='22222222222' width="" min-width=""   v-if=" '1'=='1' "  prop="create_user_id" label="创建人"  >

                    <template slot-scope="scope">
                    {{  scope.row.create_user_id }}
                    </template>
          ...
          <el-col :span="24" class="pagegroup">
                ...
                <indexDetail v-if="indexDetail.visible" :oper="indexDetail.oper" :visible="indexDetail.visible" :map="indexDetail.map" @emitComponents="emitComponents"></indexDetail>
            </el-card>
</template>
...
import indexForm from "./productForm.vue"; 
import indexDetail from "./productDetail.vue";
