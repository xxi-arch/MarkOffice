        ...
        <el-row>
            <el-col :span="24" class="breadcrumbgroup">
                ...
                <el-col :span="12" class="serachgroup">
                    ...
                    <el-button type="text" icon="el-icon-plus" size="medium"  @click="createRow()" >新建客户 </el-button>
                </el-col>
            ...
            <el-col :span="24">
                <el-table :data="list.row" border  >
                    ...
                    <el-table-column label-class-name='22222222222' width="200" min-width=""   v-if=" '1'=='1' "  prop="name" label="客户名称"  >
                    ...
                    <el-table-column label-class-name='22222222222' width="" min-width=""   v-if=" '1'=='1' "  prop="customer_level" label="客户等级"  >
                    ...
                    <el-table-column label-class-name='22222222222' width="" min-width=""   v-if=" '1'=='1' "  prop="customer_source" label="客户来源"  >

                    <template slot-scope="scope">
                    {{  scope.row.customer_source }}
                    </template>
                    ...
                    <el-table-column label-class-name='22222222222' width="" min-width=""   v-if=" '1'=='1' "  prop="customer_industry" label="行业"  >

                    <template slot-scope="scope">
                    {{  scope.row.customer_industry }}
                    </template>
                    ...
                    <el-table-column label-class-name='22222222222' width="" min-width=""   v-if=" '1'=='1' "  prop="take_user_id" label="负责人"  >

                    <template slot-scope="scope">
                    {{   util.formatterDic( 'user', scope.row.take_user_id )   }}
                    </template>
                    ...
                    <el-table-column label-class-name='22222222222' width="" min-width=""   v-if=" '1'=='1' "  prop="website" label="网址"  >
...
import indexForm from "./customerForm.vue"; 
import indexDetail from "./customerDetail.vue";
